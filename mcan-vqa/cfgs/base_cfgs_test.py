...
class Cfgs():
    def __init__(self):
        ...
        self.QUESTION_PATH = {
            'train': self.DATASET_PATH + 'train_thompson_questions.json',
            'val': self.DATASET_PATH + 'valid_thompson_questions.json',
            'test': self.DATASET_PATH + 'valid_thompson_questions.json',
            'vg': self.DATASET_PATH + 'questions.json',
        }

        self.ANSWER_PATH = {
            'train': self.DATASET_PATH + 'train_thompson_annotations.json',
            'val': self.DATASET_PATH + 'valid_thompson_annotations.json',

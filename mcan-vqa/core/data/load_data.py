...
class DataSet(Data.Dataset):
    def __init__(self, __C):
        ...
        self.img_feat_path_list = glob.glob(__C.IMG_FEAT_PATH + '/*.npy')
        ...
        self.ans_to_ix, self.ix_to_ans = ans_stat('/data3/doanhbc/thompson_data/answer_dict.json')
    ...
    def __getitem__(self, idx):
        ...
        if self.__C.RUN_MODE in ['train']:
            ...
            if self.__C.PRELOAD:
                ...
                img_feat_x = np.load(self.iid_to_img_feat_path[str(ans['image_id'])])
            ...
            if self.__C.PRELOAD:
                ...
                img_feat_x = np.load(self.iid_to_img_feat_path[str(ques['image_id'])])
            img_feat_iter = proc_img_feat(img_feat_x, self.__C.IMG_FEAT_PAD_SIZE)
